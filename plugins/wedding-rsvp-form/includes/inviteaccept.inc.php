...
$sql = "UPDATE rsvp_responses SET logged_in_once = 'TRUE', household_attending = 'TRUE', guest_one_name = '$guest_one_name', guest_one_coming = '$guest_one_status', guest_two_name = '$guest_two_name', guest_two_coming = '$guest_two_status', guest_three_name = '$guest_three_name', guest_three_coming = '$guest_three_status', guest_four_name = '$guest_four_name', guest_four_coming = '$guest_four_status', email_address_one = '$email_address_one', email_address_two = '$email_address_two', user_comments = '$user_comments' WHERE Postal_Code = '$postal_code'";

if ($conn -> query($sql) === TRUE)  {
        echo "Database Updated Successfully";
        header("Location: http://gregandnicki.com/confirm-rsvp?reply=success");
    } else  {
